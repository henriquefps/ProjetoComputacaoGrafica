...
public class BibOps {
    ...
    public static double[][] produtoVetorial3D(double[][] A, double[][] B) {
        ...
        vetor[0][0] = matrizAux[0][0] * matrizAux[1][1] * matrizAux[2][2] - (matrizAux[0][0] * matrizAux[1][2] * matrizAux[2][1]);
        vetor[1][0] = matrizAux[0][1] * matrizAux[1][2] * matrizAux[2][0] - (matrizAux[0][1] * matrizAux[1][0] * matrizAux[2][2]);
        vetor[2][0] = matrizAux[0][2] * matrizAux[1][0] * matrizAux[2][1] - (matrizAux[0][2] * matrizAux[1][1] * matrizAux[2][0]);
    ...
    public static Ponto3D cartesianaDaBaricentrica(Ponto3D p1, Ponto3D p2, Ponto3D p3, double alfa, double beta, double gama) {
    ...
    private static Ponto3D pontoDeVetor3x1(double v[][]) {
...
//		System.out.println(c.x);
    ...
    private static void preencherTrianguloSuperior(GraphicsContext gc, Ponto2D inicio, Ponto2D meio, Ponto2D fim, Triangulo t) {
    ...
    private static void preencherTrianguloInferior(GraphicsContext gc, Ponto2D inicio, Ponto2D meio, Ponto2D fim, Triangulo t) {
        double coefRetaMin, coefRetaMax;
        if (meio.x < inicio.x) {
    ...
    private static void calcularCor(int x, int scanlineY, Ponto2D inicio, Ponto2D meio, Ponto2D fim, Triangulo t) {
        ...
        if (produtoEscalar3D(N, L) < 0) {
            if (produtoEscalar3D(N, V) < 0) {
                ...
                N[1][0] -= 2 * N[1][0];
                N[2][0] -= 2 * N[2][0];
                Id = produtoComponentePonto3D(Testes.iluminacao.Il, produtoPonto3DPorEscalar(Testes.iluminacao.Od, produtoEscalar3D(N, L) *
                        Testes.iluminacao.Ks));
            } else {
                Is = new Ponto3D(0, 0, 0);
                Id = new Ponto3D(0, 0, 0);
            }
        } else {
            Id = produtoComponentePonto3D(Testes.iluminacao.Il, produtoPonto3DPorEscalar(Testes.iluminacao.Od, produtoEscalar3D(N, L) * Testes.iluminacao.Ks));
        }
...
//        System.out.println(Id.x + " " + Id.y + " " + Id.z);
    ...
    private static void scanLineEmListaDePontos(ArrayList<double[][]> listaDePontos, GraphicsContext gc, Triangulo t[]) {
        for (int i = 0; i < listaDePontos.size(); i++) {
            BibOps.scanLine(new Ponto2D(listaDePontos.get(i)[0][0], listaDePontos.get(i)[0][1]), new Ponto2D(listaDePontos.get(i)[1][0], listaDePontos.get(i)[1][1]), new Ponto2D(listaDePontos.get(i)[2][0], listaDePontos.get(i)[2][1]), gc, t[i]);
            Testes.atual++;
        }
    }
